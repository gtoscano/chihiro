...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('conversation_type', models.CharField(choices=[('T', 'Translate'), ('E', 'Edit'), ('C', 'Chat')], default='C', max_length=1)),
                ('language', models.CharField(choices=[('E', 'English'), ('S', 'Spanish'), ('F', 'French'), ('J', 'Japanese'), ('G', 'German'), ('I', 'Italian')], default='F', max_length=1)),
